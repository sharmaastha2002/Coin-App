...
const CoinDetails = () => {
  ...
  const currencySymbol = currency ==="inr"?"₹": currency ==="eru"?"€":"$"
  ...
  <HStack spacing={"4"}>
    ...
    <Radio  value={"eru"}>ERU</Radio>
  </HStack>

</RadioGroup>
<VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
  <Text fontSize={"small"} alignSelf={"center"} opacity={0.7} >last update on {Date(coin.market_data.last_upadated).split("G")[0]} </Text>
...
<Badge fontFamily={"2xl"} bgColor={"blackAlpha.800"} color={"white"} >{`#${coin.market_cap_rank}`}</Badge>
